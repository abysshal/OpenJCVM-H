...
//Component headers
#include "../vm_core/Header.h"
#include "../vm_core/directory.h"
#include "../vm_core/descriptor.h"

//Functional headers
#include "../vm_core/installer.h"
#include "../vm_core/library.h"
#include "../vm_core/JavaLang.h"
#include "../vm_core/jni.h"
...
int main(int argc, char* argv[])
{
    ...
    std::cout << "Start Load Library:" << std::endl;
    ...
    std::cout << "Start Display Library Info:" << std::endl;
    ...
    std::cout << "Start Test Run Applet:" << std::endl;
